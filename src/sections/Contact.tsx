      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-slate-900 rounded-2xl border border-slate-800 p-8 flex flex-col justify-center"
          >
            <div className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-8">
          ...
          <motion.div 
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="bg-gradient-to-br from-[#6366F1]/10 to-[#8B5CF6]/10 rounded-2xl border border-indigo-500/20 p-8"
          >
            <div className="text-[10px] font-bold text-indigo-400 uppercase tracking-widest mb-6">
            ...
            <form className="space-y-6" onSubmit={handleSubmit} noValidate>
              <div className="space-y-2">
                ...
                <input 
                  ...
                  aria-required="true"
                  className={`w-full bg-slate-900/50 border-b px-0 py-3 text-sm focus:outline-none transition-colors ${errors.name ? 'border-red-500 focus:border-red-500' : 'border-slate-700 focus:border-[#6366F1]'}`} 
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  aria-required="true"
                  className={`w-full bg-slate-900/50 border-b px-0 py-3 text-sm focus:outline-none transition-colors ${errors.email ? 'border-red-500 focus:border-red-500' : 'border-slate-700 focus:border-[#6366F1]'}`} 
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  aria-required="true"
                  className={`w-full bg-slate-900/50 border-b px-0 py-3 text-sm focus:outline-none transition-colors resize-none ${errors.message ? 'border-red-500 focus:border-red-500' : 'border-slate-700 focus:border-[#6366F1]'}`} 
              ...
              <button 
                ...
                className="w-full py-4 bg-[#6366F1] text-white text-[10px] font-bold uppercase tracking-widest rounded-lg flex items-center justify-center gap-2 hover:bg-[#5254D8] transition-colors mt-8 disabled:opacity-50 disabled:cursor-not-allowed"
              >
